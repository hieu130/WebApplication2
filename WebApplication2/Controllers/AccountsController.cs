...
namespace WebApplication2.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,DisabledAt,Address,Thumbnail,PhoneNumber,Status,RoleNumber,EmployeeNumber,AddmissionDate,DateOfJoining")] Account account)
        {
